        ...
        return (<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div className="ibox float-e-margins">
                <div className="ibox-title">
                    <h5><i className="fa fa-clipboard" aria-hidden="true"></i>Worksheet</h5>
                </div>
                        ...
                        <div className="col-md-12 col-xs-12 col-sm-12 col-lg-12">
                            <Form>
                                <div className="row">
                                    ...
                                    <div className="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                                        <FormGroup label="Task" required={true}>
                                            <Input type="text" autoFocus={false} placeholder="Task" className="form-control" name="Task" value={this.props.data.task} />
                                        </FormGroup>
                                    </div>

                                    <div className="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                                        <FormGroup label="Date" required={true}>
                                            <Input type="text" autoFocus={false} placeholder="Date" className="form-control" name="Date" value={this.props.data.Date} />
                                        </FormGroup>
                                    </div>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                                        <FormGroup label="Start Time" required={true}>
                                            <Input type="text" autoFocus={false} placeholder="Start Time" className="form-control" name="StartTime" value={this.props.data.StartTime} />
                                        </FormGroup>
                                    </div>

                                    <div className="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                                        <FormGroup label="End Time" required={true}>
                                            <Input type="text" autoFocus={false} placeholder="End Time" className="form-control" name="EndTime" value={this.props.data.EndTime} />
                                        </FormGroup>
                                    </div>
...
let mapStateToProps = function (state) {
    return {
        'data': state.hr.timesheet.worksheet.get("data").toObject()
    }
}
...
module.exports = connect(mapStateToProps, mapDispatchToProps)(Worksheet) 